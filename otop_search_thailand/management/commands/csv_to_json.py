...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-o", "--output", type=str, default=None, help="Output JSON path (default: same name .json)")
        parser.add_argument("--encoding", type=str, default="utf-8-sig", help="CSV encoding")
        parser.add_argument("--sheet", type=str, default=None, help="Excel sheet name/index (optional)")

    def handle(self, *args, **opts):
        in_path = Path(opts["input_path"]) ; out_path = opts["output"]
        ...
        if ext == ".csv":
            ...
            try:
                ...
                raise CommandError("Reading Excel requires pandas + openpyxl: pip install pandas openpyxl")
